...
<html lang="en">
  ...
  <body>
    ...
    <legend class="header">FORM BELANJA</legend>
    <div class="container">

        <div class="row">
            <div class="col">
                <form class="form" method="POST" action="form_belanja.php"> 
                    ...
                    <fieldset class="form-group row">
                        <label class="col-form-label col-sm-2 float-sm-left pt-0" for="produk">Nama Produk</label>
                        <div class="col-sm-10" id="produk" class="produk">
                            <div class="row">
